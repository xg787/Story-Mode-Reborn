...
import static net.xg787.xgsmi.registry.XgsmiItems.ROMEUM_INGOT;
import static net.xg787.xgsmi.registry.XgsmiItems.TITANIUM_INGOT;

public class XgsmiToolTiers {
    public static final Tier PRISMARINE = new SimpleTier(INCORRECT_FOR_IRON_TOOL, 200, 4f, 2f, 12, () -> Ingredient.of(XgsmiTags.Items.PRISMARINE_TOOL_MATERIAL));
