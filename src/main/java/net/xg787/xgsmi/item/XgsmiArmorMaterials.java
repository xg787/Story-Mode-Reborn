...
public class XgsmiArmorMaterials {
    ...
    public static final Holder<ArmorMaterial> TITANIUM = register("titanium",
            ...
            }),SoundEvents.ARMOR_EQUIP_NETHERITE, 20, 3.5f, 0.2f, () -> XgsmiItems.TITANIUM_INGOT.get());
    ...
    public static final Holder<ArmorMaterial> ENCHANTED_TITANIUM = register("enchanted_titanium",
            ...
            }),SoundEvents.ARMOR_EQUIP_NETHERITE, 25, 3.5f, 0.25f, () -> XgsmiItems.TITANIUM_INGOT.get());
    ...
    public static final Holder<ArmorMaterial> MCSM_TITANIUM = register("mcsm_titanium",
            ...
            }),SoundEvents.ARMOR_EQUIP_NETHERITE, 35, 4.5f, 0.4f, () -> XgsmiItems.TITANIUM_INGOT.get());
    ...
    public static final Holder<ArmorMaterial> ROMEUM = register("romeum",
            ...
            }),SoundEvents.ARMOR_EQUIP_NETHERITE, 30, 4.0f, 0.3f, () -> XgsmiItems.ROMEUM_INGOT.get());
    ...
    public static final Holder<ArmorMaterial> ENCHANTED_ROMEUM = register("enchanted_romeum",
            Util.make(new EnumMap<>(ArmorItem.Type.class), attribute -> {
                ...
                attribute.put(ArmorItem.Type.BOOTS, 5);
                attribute.put(ArmorItem.Type.BODY, 15);
            }),SoundEvents.ARMOR_EQUIP_NETHERITE, 35, 4.5f, 0.35f, () -> XgsmiItems.ROMEUM_INGOT.get());
    ...
    public static final Holder<ArmorMaterial> CHAMPION = register("champion",
            ...
            }),SoundEvents.ARMOR_EQUIP_NETHERITE, 45, 5.5f, 0.45f, () -> XgsmiItems.ROMEUM_INGOT.get());
