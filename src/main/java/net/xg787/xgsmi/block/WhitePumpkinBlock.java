...
public class WhitePumpkinBlock extends Block {
    ...
    public WhitePumpkinBlock(BlockBehaviour.Properties p_55284_) {
        super(p_55284_);
    }
    ...
    protected ItemInteractionResult useItemOn(
        ...
        if (!p_316383_.canPerformAction(net.neoforged.neoforge.common.ItemAbilities.SHEARS_CARVE)) {
            ...
            p_316272_.setBlock(p_316484_, CARVED_WHITE_PUMPKIN.get().defaultBlockState().setValue(CarvedPumpkinBlock.FACING, direction1), 11);
            ItemEntity itementity = new ItemEntity(
                    ...
                    new ItemStack(WHITE_PUMPKIN_SEEDS.get(), 4)
            );
