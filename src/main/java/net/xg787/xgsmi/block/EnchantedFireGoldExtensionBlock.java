...
public class EnchantedFireGoldExtensionBlock extends EnchantedFireDiamondBlock {
    public EnchantedFireGoldExtensionBlock(Properties properties) {
        super(properties);
    }
    ...
    public static BlockState getState(BlockGetter reader, BlockPos pos) {
        return ((AbstractEnchantedFireBlock)StoryModeRebornBlocks.ENCHANTED_FIRE_GOLD_EXTENSION.get()).getStateForPlacement(reader, pos);
    }
    ...
    public BlockState getStateWithAge(LevelAccessor level, BlockPos pos, int age) {
        ...
        return blockstate.is(StoryModeRebornBlocks.ENCHANTED_FIRE_GOLD_EXTENSION) ? blockstate.setValue(AGE, Integer.valueOf(age)) : blockstate;
    }
